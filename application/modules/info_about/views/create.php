				...
				<div class="m-portlet">
					...
					<!--begin::Form-->
          			<?php
						...
						echo form_open_multipart(ADMIN_BASE_URL . 'info_about/submit/', $attributes, $hidden);
					?> 
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-md-4">
								...
								<div class="" imagetype="imagevalidation" id="<?=(isset($update_id) && !empty($update_id) ? $update_id : '')?>"  image="<?=(isset($services['image']) && !empty($services['image']) ? $services['image'] : '');?>">
									<?php 
										$path = (isset($services['image']) && !empty($services['image']) ? Modules::run('api/image_path_with_default',ACTUAL_INFO_ABOUT_IMAGE_PATH, $services['image'], STATIC_FRONT_IMAGE, DEFAULT_info_about) : '');
										$path = ($path == STATIC_FRONT_IMAGE.DEFAULT_info_about ? '' : $path);
									?>
						...
						<div class="m-form__actions m-form__actions--solid">
							<div class="row">
								...
								<div class="col-lg-8">
									...
									<a href="<?php echo ADMIN_BASE_URL . 'info_about'; ?>">
                ...
                swal({   
                    ...
                    if (isConfirm.value) {
                        ...
                        if(id) {
                            $.ajax({
                                type: 'POST',
                                url: "<?= ADMIN_BASE_URL?>info_about/delete_image",
