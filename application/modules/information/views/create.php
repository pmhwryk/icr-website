				...
				<div class="m-portlet">
					...
					<!--begin::Form-->
          			<?php
						...
						echo form_open_multipart(ADMIN_BASE_URL . 'information/submit/', $attributes);
					?> 

<input type="hidden" name="update_id" value="<?=(isset($services['id']) && !empty($services['id']) ? $services['id'] : '')?>">
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-md-4">
								...
								<div class="" imagetype="imagevalidation" id="<?=(isset($update_id) && !empty($update_id) ? $update_id : '')?>"  image="<?=(isset($services['image']) && !empty($services['image']) ? $services['image'] : '');?>">
									<?php 
										$path = (isset($services['image']) && !empty($services['image']) ? Modules::run('api/image_path_with_default',ACTUAL_INFORMATION_IMAGE_PATH, $services['image'], STATIC_FRONT_IMAGE, DEFAULT_PACKAGES) : '');
						...
						<div class="m-form__actions m-form__actions--solid">
							<div class="row">
								...
								<div class="col-lg-8">
									...
									<a href="<?php echo ADMIN_BASE_URL . 'information'; ?>">
