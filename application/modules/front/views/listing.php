<link type="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.carousel.min.css">
    ...
    outline: none;
    border-radius: 5%;
    padding: 15px; /* Adjust the desired padding */
    font-size: 20px; /* Adjust the desired font size */
    z-index: 9999; /* Ensure the button appears on top of other content */
    box-shadow: 0 2px 5px rgba(0, 0, 0, 0.3); /* Adjust the desired box shadow */
  ...
  .floating-buttons:hover::before {
    transform: rotate(45deg) scale(1.1); /* Adjust the desired scale value to make the sticker slightly bigger on hover */
  }
  ...
  .floating-buttons::after {
    ...
    width: 10px;
    height: 10px;
    background-color: #fff; /* Adjust the desired color of the sparkles */
    border-radius: 50%;
    opacity: 0;
  ...
  .floating-buttons:hover {
    box-shadow: 0 4px 10px rgba(0, 0, 0, 0.5); /* Adjust the desired box shadow on hover */
  }
   ...
   <style>
            ...
            <div class="row">
                    ...
                    <div class="main-banner-content">
                        <div class="d-table">
                            <div class="d-table-cell">
                                <div class="content">
                                    <h1><?= ((isset($general_setting['home_heading']) && !empty($general_setting['home_heading'])) ? $general_setting['home_heading'] : '') ?></h1>
                ...
                <div class="col-lg-5 col-md-12">
                    ...
                    <div class="home-slider owl-carousel owl-theme">
                        ...
                        ?>
                                <img class="banner-image" src="<?= Modules::run('api/image_path_with_default', ACTUAL_GENERAL_SETTING_IMAGE_PATH, (isset($slide['image']) && !empty($slide['image']) ? $slide['image'] : ''), STATIC_FRONT_IMAGE, DEFAULT_IMAGE) ?>" alt="<?= (isset($slide['alt_text']) && !empty($slide['alt_text'])) ? $slide['alt_text'] : ''; ?>">
                        <?php }
                        } ?>
                    </div>
                </div>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                <div class="col-lg-12 col-md-12" style="text-align: justify;">
                    <p><strong><?= ((isset($general_setting['about_heading']) && !empty($general_setting['about_heading'])) ? $general_setting['about_heading'] : '') ?></strong><br /> <?= ((isset($general_setting['about_short']) && !empty($general_setting['about_short'])) ? $general_setting['about_short'] : '') ?></p>
                    <div class="default-btn" style="margin-top:15px;">
            ...
            <div class="row align-items-center">
                <div class="services-content it-service-content">
                    <div class="content left-content">
                        ...
                        <div style="text-align: justify;">
                            <p>ICR is providing a positive and healthy work environment to promote employees' safety, growth, and goal attainment.</p>
    ...
    <section class="features-area ptb-100 bg-f4f6fc">
        <div class="container">
            <div class="section-title">
                <h2><?= ((isset($general_setting['feature_heading']) && !empty($general_setting['feature_heading'])) ? $general_setting['feature_heading'] : '') ?></h2>
            </div>
            <div class="row">
                <?php $i=1;
                 if (isset($features_slide) && !empty($features_slide)) {
    ...
    <section class="our-loving-clients pt-100">
        <div class="container">
            <div class="section-title">
                <h2><?= ((isset($general_setting['platform_heading']) && !empty($general_setting['platform_heading'])) ? $general_setting['platform_heading'] : '') ?></h2>
            </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="features-box-one wow fadeInLeft" data-wow-delay=".1s" style="padding:30px">
                        <a href="https://www.freelancer.com/">
                            <img src="<?= STATIC_FRONT_ASSETS ?>img/platforms/freelancer_platform-1.png" alt="image" style=" max-width: 100%;height: 50px;" class="img-fluid">
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="features-box-one wow fadeInLeft" data-wow-delay=".1s" style="padding:30px">
                        <a href="https://www.upwork.com/">
                            <img src="<?= STATIC_FRONT_ASSETS ?>img/platforms/freelancer_platform-2.png" alt="image" style=" max-width: 100%;height: 50px;" class="img-fluid">
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="features-box-one wow fadeInLeft" data-wow-delay=".1s" style="padding:30px">
                        <a href="https://www.fiverr.com/">
                            <img src="<?= STATIC_FRONT_ASSETS ?>img/platforms/freelancer_platform-3.png" alt="image" style=" max-width: 100%;height: 50px;" class="img-fluid">
                        </a>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6">
                    <div class="features-box-one wow fadeInLeft" data-wow-delay=".1s" style="padding:30px">
                        <a href="https://www.peopleperhour.com/">
                            <img src="<?= STATIC_FRONT_ASSETS ?>img/platforms/freelancer_platform-4.png" alt="image" style=" max-width: 128%;height: 50px;" class="img-fluid">
                        </a>
                    </div>
                </div>
            </div>
    ...
    <script>
        $(document).off('click', '.read_more2').on('click', '.read_more2', function(event){
        event.preventDefault();
        var id = $(this).data('id');
        var description = $(this).data('description');
        var text = $('#hit-' + id).text('');
        $('#hit-' + id).text(description);
        $(this).remove();
    });
  ...
  floatingButton.innerHTML = "Join Free IT-Boot Camp";
  floatingButton.classList.add("floating-buttons");
  floatingButton.addEventListener("click", function() {
    window.location.href = "https://docs.google.com/forms/d/e/1FAIpQLScvc-HeN2NFnOhJxS1nd_jt5gYXPbz14jbxF6ZvsHSbtYnLkA/viewform";
  });
