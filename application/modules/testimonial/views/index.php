				...
				<div class="m-portlet__head-caption">
					...
					<div class="m-portlet__head-title">
						...
						<h3 class="m-portlet__head-text">
							...
							<i class="m-menu__link-icon flaticon-edit"></i> TestImonial
				...
				<div class="m-portlet__head-tools">
					...
					<ul class="m-portlet__nav">
						...
						<li class="m-portlet__nav-item">
							...
							<a href="<?=ADMIN_BASE_URL?>testimonial/create" class="btn btn-primary m-btn m-btn--pill m-btn--custom m-btn--icon m-btn--air">
					...
					<tbody>
                        ...
                        if (isset($query)) {
                        	...
                        	foreach ($query->result() as $row):
                        		...
                        		$edit_url = ADMIN_BASE_URL . 'testimonial/create/' . $row->id;
...
<script type="application/javascript">
	...
	$(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
		...
		swal({
			...
			title : "Are you sure to delete the selected Testimonial?",
			...
			if(e.value) {
				...
				$.ajax({
					...
					url: "<?= ADMIN_BASE_URL?>testimonial/delete",
			...
			if("cancel" === e.dismiss)
				...
				swal("Cancelled", "testimonial is safe :)", "error");
	...
	$(document).on("click", ".view_details", function(event){
		...
		$.ajax({
			...
			url: "<?=ADMIN_BASE_URL?>testimonial/detail",
    ...
    $(document).off("click",".action_publish").on("click",".action_publish", function(event) {
		...
		type: 'POST',
			...
			url: "<?= ADMIN_BASE_URL ?>testimonial/change_status",
