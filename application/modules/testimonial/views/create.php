				...
				<div class="m-portlet">
					...
					<!--begin::Form-->
          			<?php
						...
						echo form_open_multipart(ADMIN_BASE_URL . 'testimonial/submit/', $attributes, $hidden);
					?> 
						...
						<div class="form-group m-form__group row">
							...
							<div class="col-md-6">
								...
								<div class="input-group m-input-group m-input-group--square">
									...
									<input type="text" class="form-control m-input" id="title" name="designation" value="<?=(isset($services['designation']) && !empty($services['designation']) ? $services['designation'] : '')?>">
								</div>
							</div>
						</div>
                        <div class="form-group m-form__group row">
							<div class="col-md-6">
								...
								<div class="input-group m-input-group m-input-group--square">
									...
									<input type="text" class="form-control m-input" id="title" name="website" value="<?=(isset($services['website']) && !empty($services['website']) ? $services['website'] : '')?>">
								</div>
							</div>
							<div class="col-md-6">
								<label>
								Desription <span style="color:red">*</span>
								</label>
								<div class="input-group m-input-group m-input-group--square">
									<div class="input-group-prepend">
										<span class="input-group-text">
						...
						<div class="form-group m-form__group row">
							<div class="col-md-6">
								...
								<div class="" imagetype="imagevalidation" id="<?=(isset($update_id) && !empty($update_id) ? $update_id : '')?>"  image="<?=(isset($services['image']) && !empty($services['image']) ? $services['image'] : '');?>">
									<?php 
										$path = (isset($services['image']) && !empty($services['image']) ? Modules::run('api/image_path_with_default',ACTUAL_TESTIMONIAL_IMAGE_PATH, $services['image'], STATIC_FRONT_IMAGE, DEFAULT_STATISTICS) : STATIC_FRONT_IMAGE.DEFAULT_STATISTICS);
						...
						<div class="m-form__actions m-form__actions--solid">
							<div class="row">
								...
								<div class="col-lg-8">
									...
									<a href="<?php echo ADMIN_BASE_URL . 'testimonial'; ?>">
                ...
                swal({   
                    ...
                    if (isConfirm.value) {
                        ...
                        if(id) {
                            $.ajax({
                                type: 'POST',
                                url: "<?= ADMIN_BASE_URL?>testimonial/delete_image",
