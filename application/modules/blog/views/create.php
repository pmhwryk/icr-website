				...
				<div class="m-portlet">
					...
					<!--begin::Form-->
          			<?php
						...
						echo form_open_multipart(ADMIN_BASE_URL . 'blog/submit/', $attributes, $hidden);
					?> 
						...
						<div class="form-group m-form__group row">
							<div class="col-md-6">
								...
								<div class="input-group m-input-group m-input-group--square">
									...
									<input type="text" class="form-control m-input" id="title" name="title" value="<?=(isset($services['title']) && !empty($services['title']) ? $services['title'] : '')?>">
								</div>
							</div>
							<div class="col-md-6">
								<label>
								...
								<div class="input-group m-input-group m-input-group--square">
									...
									<input type="text" class="form-control m-input" id="title" name="short_desc" value="<?=(isset($services['short_desc']) && !empty($services['short_desc']) ? $services['short_desc'] : '')?>">
								</div>
							</div>
							...
							<div class="col-md-6">
								...
								<div class="input-group m-input-group m-input-group--square">
									...
									<input type="text" class="form-control m-input" id="title" name="url" value="<?=(isset($services['url']) && !empty($services['url']) ? $services['url'] : '')?>">
								</div>
							</div>
                        ...
                        <div class="form-group m-form__group row">
							 <div class="col-md-6">
								...
								<div class="input-group m-input-group m-input-group--square">
									...
									<input type="text" class="form-control m-input" id="title" name="by_whom" value="<?=(isset($services['by_whom']) && !empty($services['by_whom']) ? $services['by_whom'] : '')?>">
								</div>
							</div> 

							<div class="col-md-6">
								<label>
								Blog publish date <span style="color:red">*</span>
								</label>
								<div class="input-group m-input-group m-input-group--square">
									<div class="input-group-prepend">
										<span class="input-group-text">
									...
									<input type="text" class="form-control m-input" id="" name="blog_date" value="<?=(isset($services['blog_date']) && !empty($services['blog_date']) ? $services['blog_date'] : '')?>">
								</div>
							</div>
							...
							<!-- <div class="col-md-6">
								...
								<div class="" imagetype="imagevalidation" id="<?=(isset($update_id) && !empty($update_id) ? $update_id : '')?>"  image="<?=(isset($services['auth_image']) && !empty($services['auth_image']) ? $services['auth_image'] : '');?>">
									<?php 
										$path = (isset($services['auth_image']) && !empty($services['auth_image']) ? Modules::run('api/image_path_with_default',ACTUAL_BLOG_IMAGE_PATH, $services['auth_image'], STATIC_FRONT_IMAGE, DEFAULT_STATISTICS) : STATIC_FRONT_IMAGE.DEFAULT_STATISTICS);
										$path = ($path == STATIC_FRONT_IMAGE.DEFAULT_STATISTICS ? '' : $path);
									?>
									<input type="file" name="auth_image"  class="dropify imagevalidation notrequired"  accept='image/*' data-default-file="<?=$path?>">
									<input type="hidden" name="old" class="form-control m-input" value="<?=(isset($services['auth_image']) && !empty($services['auth_image']) ? $services['auth_image'] : '');?>" >
								</div>
							</div> -->

							 <div class="col-md-6">
								<label>
								Author description <span style="color:red">*</span>
								</label>
								<div class="input-group m-input-group m-input-group--square">
									<div class="input-group-prepend">
										<span class="input-group-text">
									...
									<input type="text" class="form-control m-input" id="title" name="auth_desc" value="<?=(isset($services['auth_desc']) && !empty($services['auth_desc']) ? $services['auth_desc'] : '')?>">
								</div>
							</div> 

							<!-- <div class="col-md-6">
								<label>
								Author link <span style="color:red">*</span>
								</label>
								<div class="input-group m-input-group m-input-group--square">
									<div class="input-group-prepend">
										<span class="input-group-text">
									...
									<input type="text" class="form-control m-input" id="title" name="auth_link" value="<?=(isset($services['auth_link']) && !empty($services['auth_link']) ? $services['auth_link'] : '')?>">
								</div>
							</div>
						 -->
							<div class="col-md-6">
							...
							<div class="col-lg-12">
								...
								<div class="input-group m-input-group m-input-group--square">
                                <textarea name="long_desc" rows="4" class="summernote  form-control"> <?=(isset($services['blog_detail']) && !empty($services['blog_detail']) ? $services['blog_detail'] : '')?></textarea>
                ...
                swal({   
                    ...
                    if (isConfirm.value) {
                        ...
                        if(id) {
                            $.ajax({
                                type: 'POST',
                                url: "<?= ADMIN_BASE_URL?>blog/delete_image",
