...
<style>
    ...
    .floating-buttons {
        ...
        /* Adjust the desired background color */
        color: #fff;
        /* Adjust the desired text color */
        border: none;
        outline: none;
        border-radius: 5%;
        padding: 15px;
        /* Adjust the desired padding */
        font-size: 20px;
        /* Adjust the desired font size */
        z-index: 9999;
        /* Ensure the button appears on top of other content */
        box-shadow: 0 2px 5px rgba(0, 0, 0, 0.3);
        /* Adjust the desired box shadow */
        cursor: pointer;
    ...
    .floating-buttons::before {
        ...
        right: -10px;
        width: 30px;
        /* Adjust the desired width of the sticker */
        height: 30px;
        /* Adjust the desired height of the sticker */
        background-color: #3D3D3D;
        /* Adjust the desired background color of the sticker */
        border-radius: 50%;
        /* Adjust the desired border radius to create a circle */
    ...
    .floating-buttons:hover::before {
        ...
        /* Adjust the desired scale value to make the sticker slightly bigger on hover */
    }
    ...
    .floating-buttons::after {
        ...
        /* Adjust the desired color of the sparkles */
        border-radius: 50%;
        opacity: 0;
    ...
    .floating-buttons:hover {
        ...
        /* Adjust the desired box shadow on hover */
    }
</style>
<style>
    .post-slide {
...
<div class="main-banner main-banner-one">
    ...
    <div class="shape20"><img src="<?= STATIC_FRONT_IMAGE ?>shape/Frame 2.png" alt="image"></div>
    <div class="shape21"><img src="<?= STATIC_FRONT_IMAGE ?>shape/Frame 3.png" alt="image"></div>
...
<div class="subscribe-content border-radius-0" id="hidsection">
    ...
    <div class="shape18"><img src="<?= STATIC_FRONT_IMAGE ?>shape/Frame 7.png" alt="image"></div>
</div>
