						...
						<div class="form-group m-form__group row">
							...
							<div class="col-md-4">
								...
								<div class="" imagetype="imagevalidation" id="<?=(isset($update_id) && !empty($update_id) ? $update_id : '')?>"  image="<?=(isset($services['image']) && !empty($services['image']) ? $services['image'] : '');?>">
									<?php 
										$path = (isset($services['image']) && !empty($services['image']) ? Modules::run('api/image_path_with_default',ACTUAL_FEATURES_IMAGE_PATH, $services['image'], STATIC_FRONT_IMAGE, DEFAULT_PACKAGES) : '');
						...
						<div class="m-form__actions m-form__actions--solid">
							<div class="row">
								...
								<div class="col-lg-8">
									...
									<a href="<?php echo ADMIN_BASE_URL . 'features'; ?>">
