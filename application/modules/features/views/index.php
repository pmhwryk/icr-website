...
<script type="application/javascript">
	$(document).off('click', '.delete_record').on('click', '.delete_record', function(e){
        ...
        e.preventDefault();
		swal({
			title : "Are you sure to delete the selected features?",
			text : "You will not be able to recover this features!",
			type : "warning",
			...
			if("cancel" === e.dismiss)
				swal("Cancelled", "Features is safe :)", "error");
		});
    });
	...
	$(document).on("click", ".action_top_page", function(event) {
		...
		$.ajax({
			type: 'POST',
			url: "<?=ADMIN_BASE_URL ?>features/set_as_homepage",
